...
export const member = pgTable("member", {
	...
	canCreateEnvironments: boolean("canCreateEnvironments")
		.notNull()
		.default(false),
	canAccessToEmail: boolean("canAccessToEmail").notNull().default(false),
	canCreateEmailDomains: boolean("canCreateEmailDomains")
		.notNull()
		.default(false),
	canDeleteEmailDomains: boolean("canDeleteEmailDomains")
		.notNull()
		.default(false),
	canCreateEmailAccounts: boolean("canCreateEmailAccounts")
		.notNull()
		.default(false),
	canDeleteEmailAccounts: boolean("canDeleteEmailAccounts")
		.notNull()
		.default(false),
	canManageEmailForwards: boolean("canManageEmailForwards")
		.notNull()
		.default(false),
